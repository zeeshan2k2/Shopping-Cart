A Shopping List app where user can enter the items they would like. It displays items using UITable View. Users can delete items individually and also delete all items at once.
